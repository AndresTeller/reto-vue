    ...
    <div class="custom-modal">
      <div class="columns is-multiline px-5">
        ...
        <div class="column is-12">
          <div class="field">
            <label class="has-text-grey has-text-weight-light"
              >Descripción<span class="has-text-danger">*</span></label
            >
            <div class="control">
        ...
        <div class="column is-6">
          <div class="field">
            <label class="has-text-grey has-text-weight-light"
              >Cantidad<span class="has-text-danger">*</span></label
            >
            <div class="control">
        ...
        <div class="column is-6">
          <div class="field">
            <label class="has-text-grey has-text-weight-light"
              >Proveedor<span class="has-text-danger">*</span></label
            >
            <div class="control">
        ...
        <div class="column is-12">
          <div class="field">
            <label class="has-text-grey has-text-weight-light"
              >Firma del encargado<span class="has-text-danger">*</span></label
            >
            <div class="control">
